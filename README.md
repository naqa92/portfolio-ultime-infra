...
│   ├── storage-class.tf        # StorageClass EBS + EFS
...
- Terraform :
  ...
  - Destroy : Gérer load balancer, route53, ACM, volumes et VPC (finalizers)
  - Passer d'ALB Controller à Gateway Controller
  - Secret manager via tf pour la synchronisation du repo `portfolio-ultime-config` en privé
